      ...
      <ul class="setting-list">
        ...
        <li v-clickoutside="onUpdatingUserNameHidden" class="item">
          ...
          <div class="input-box profile-input">
            ...
            <div class="action-box">
              <button
                v-show="!updatingUserName"
                @click="onUpdatingUserName"
                tabindex="-1"
                class="btn edit-btn"
              >
              ...
              <button
                v-show="updatingUserName"
                @click="onSave('username', 'oldUsername', 'updatingUserName')"
                class="user-save-btn"
              >保存</button>
              <button
                v-show="updatingUserName"
                @click="onUpdatingUserNameHidden('cancel')"
        ...
        <li v-clickoutside="onUpdatingJobHidden" class="item">
          ...
          <div class="input-box profile-input">
            ...
            <div class="action-box">
              ...
              <button
                v-show="updatingJob"
                @click="onSave('job', 'oldJob', 'updatingJob')"
                class="user-save-btn"
              >保存</button>
              <button
                v-show="updatingJob"
                @click="onUpdatingJobHidden('cancel')"
                class="user-cancel-btn"
              >取消</button>
            </div>
          </div>
        ...
        <li v-clickoutside="onUpdatingCompanyHidden" class="item">
          ...
          <div class="input-box profile-input">
            ...
            <div class="action-box">
              <button
                v-show="!updatingCompany"
                @click="onUpdatingCompany"
                tabindex="-1"
                class="btn edit-btn"
              >
                <img src="../../../images/settings/edit_icon.svg" class="icon" />
              ...
              <button
                v-show="updatingCompany"
                @click="onSave('company', 'oldCompany', 'updatingCompany')"
                class="user-save-btn"
              >保存</button>
              <button
                v-show="updatingCompany"
                @click="onUpdatingCompanyHidden('cancel')"
                class="user-cancel-btn"
              >取消</button>
            </div>
          </div>
        ...
        <li v-clickoutside="onUpdatingIntroduceHidden" class="item">
          ...
          <div class="input-box profile-input">
            ...
            <div class="action-box">
              <button
                v-show="!updatingIntroduce"
                @click="onUpdatingIntroduce"
                tabindex="-1"
                class="btn edit-btn"
              >
                <img src="../../../images/settings/edit_icon.svg" class="icon" />
              ...
              <button
                v-show="updatingIntroduce"
                @click="onSave('introduce', 'oldIntroduce', 'updatingIntroduce')"
                class="user-save-btn"
              >保存</button>
              <button
                v-show="updatingIntroduce"
                @click="onUpdatingIntroduceHidden('cancel')"
                class="user-cancel-btn"
              >取消</button>
            </div>
          </div>
        ...
        <li v-clickoutside="onUpdatingPersonalHomePageHidden" class="item">
          ...
          <div class="input-box profile-input">
            <input
              v-model="personalHomePage"
              @focus="onUpdatingPersonalHomePage"
              spellcheck="false"
            ...
            <div class="action-box">
              <button
                v-show="!updatingPersonalHomePage"
                @click="onUpdatingPersonalHomePage"
                tabindex="-1"
                class="btn edit-btn"
              >
                <img src="../../../images/settings/edit_icon.svg" class="icon" />
              ...
              <button
                v-show="updatingPersonalHomePage"
                @click="onSave('personalHomePage', 'oldPersonalHomePage', 'updatingPersonalHomePage')"
                class="user-save-btn"
              >保存</button>
              <button
                v-show="updatingPersonalHomePage"
                @click="onUpdatingPersonalHomePageHidden('cancel')"
                class="user-cancel-btn"
              >取消</button>
            </div>
          </div>
