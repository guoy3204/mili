...
1. 本小书为图文形式内容服务，共计 N 节
2. 全部文章预计 x 月 x 日更新完成；
3. 购买用户可享有小书永久的阅读权限；
4. 购买用户可进入小书微信群，与作者互动；
5. {{siteName}}小书为虚拟内容服务，一经购买成功概不退款；
6. {{siteName}}小书版权归{{companyName}}所有，任何机构、媒体、网站或个人未经本网协议授权不得转载、链接、转贴或以其他方式复制发布/发表，违者将依法追究责任；
7. 在{{siteName}}小书阅读过程中，如有任何问题，请邮件联系{{postEmail}}
`;
